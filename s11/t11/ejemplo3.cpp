...
public:
    ProxyVideo(const string& titulo, const string& url, bool tienePermiso, bool regionPermitida)
...
int main() {
    ...
    video2->reproducir(); // Resultado esperado: No se puede reproducir el video. Permiso o región no válidos.

    video3->reproducir(); // Resultado esperado: No se puede reproducir el video. Permiso o región no válidos.
